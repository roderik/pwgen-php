...
class PWGen
{
    ...
    {
        return ($this->pwgen_flags & self::PW_DIGITS) === self::PW_DIGITS &&
            ($this->pwgen_flags & self::PW_UPPERS) === self::PW_UPPERS
        ;
    }
    ...
    {
        return ($this->pwgen_flags & self::PW_UPPERS) === self::PW_UPPERS;
    }
    ...
    {
        return ($this->pwgen_flags & self::PW_AMBIGUOUS) === self::PW_AMBIGUOUS;
    }
    ...
    {
        return ($this->pwgen_flags & self::NO_VOWELS) === self::NO_VOWELS &&
            ($this->pwgen_flags & self::PW_DIGITS) === self::PW_DIGITS &&
                ($this->pwgen_flags & self::PW_UPPERS) === self::PW_UPPERS
        ;
    }
    ...
    {
        return ($this->pwgen_flags & self::PW_SYMBOLS) === self::PW_SYMBOLS;
    }
    ...
    {
        return self::$pw_ambiguous;
    }

    public function getSymbols()
    {
        return self::$pw_symbols;
    }

    public function getVovels()
    {
        return self::$pw_vowels;
    }
